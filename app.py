this script fails to click through every link it finds and also store those things. Check the crawl4ai documentation to see how we can fix it. import nest_asyncio
nest_asyncio.apply()
import os
import asyncio
import json
